...
export const SuperAdminView: React.FC<SuperAdminViewProps> = ({
  ...
  if (!isSuperAdmin) {
    return (
      <div className="p-8 max-w-2xl mx-auto my-12 bg-[#1A1A2E]/90 border border-red-500/30 rounded-3xl text-center space-y-4 backdrop-blur-xl shadow-2xl">
        <div className="w-16 h-16 rounded-3xl bg-red-500/10 text-red-400 flex items-center justify-center mx-auto border border-red-500/20">
        ...
        <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-xs text-slate-300 mt-1">
              Provision platform members, assign directorates, manage security permissions, and monitor telemetry.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-4 py-2.5 rounded-2xl bg-gradient-to-r from-[#E85D04] to-[#F4A261] hover:opacity-95 text-white font-bold text-xs uppercase tracking-wider flex items-center gap-2 shadow-lg glow-orange transition"
            >
